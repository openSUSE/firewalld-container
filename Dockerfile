...
LABEL maintainer="Arvin Schnell <aschnell@suse.com>"
...
# labelprefix=com.suse.alp.workloads.firewalld
...
LABEL org.opencontainers.image.url="https://github.com/openSUSE/firewalld-container"
